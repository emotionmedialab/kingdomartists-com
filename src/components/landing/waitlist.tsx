            ...
            {status === "success" ? (
              ...
              >
                <input
                  ...
                  className="w-full bg-background/[0.06] border border-background/[0.08] text-background placeholder:text-background/25 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-background/20 transition-colors"
                />
                <input
                  type="email"
                ...
                <select
                  ...
                  className="w-full bg-background/[0.06] border border-background/[0.08] text-background/60 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-background/20 transition-colors appearance-none"
                >
